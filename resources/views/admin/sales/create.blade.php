                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="invNumber" placeholder="000AX" value="{{ old('invNumber') }}" required>
                            </div>
                        </div>
                        <div class="form-group col">
                            <label>Select Customer</label>
                            <select class="form-control" id="customerName" name="customerName" onchange="prodAdd()" required>
                                <option value="" selected>Select Customer</option>
                                @foreach ($customer as $customer)
                                <option value="{{ $customer->customerName }}" id="{{ $customer->id }}">{{ $customer->customerName }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group col">
                            <label>Purchase Date</label>
                            <input type="date" class="form-control" name="purchaseDate" placeholder="dd-mm-yyyy" value="{{ old('purchaseDate') }}" required>
                        </div>
                    </div>
                    <div class="extra-row" id="appendRow">
                        <div class="row mt-3">
                            ...
                            <div class="form-group col">
                                ...
                                <input type="number" class="form-control" name="prodRate[]" id="prodRate1" onkeyup="parchaseCal(1)" placeholder="0.00" required>
                            </div>
                            <div class="form-group col">
                                <label>Total Price</label>
                                <input type="number" class="form-control totCount" name="totalPrice[]" id="totalPrice1" placeholder="Total Price" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group col">
                                ...
                                <input type="text" class="form-control" name="transactionMethod" id="transactionMethod" placeholder="Transection Method" required>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group col">
                                <label>Note</label>
                                <input type="text" class="form-control" name="note" id="note" placeholder="Note About Transection" required>
                            </div>
                        </div>
                        <div class="form-group col">
                            <label>Grand Total</label>
                            <input type="number" class="form-control" name="grandTotal" id="grandTot" onkeyup="parchaseCal()" placeholder="Grand Total" required>
                        </div>
                        <div class="form-group col">
                            <label>Paid Amount</label>
                            <input type="number" class="form-control" name="paidAmount" id="paidAmount" onkeyup="parchaseCal()" placeholder="0.00" required>
                        </div>
                        <div class="form-group col">
                            <label>Dues Amunt</label>
                            <input type="number" class="form-control" name="duesAmount" id="duesAmount" placeholder="Dues Amount" required>
                        </div>
                    </div>
