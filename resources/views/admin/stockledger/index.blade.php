...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="">
            <div class="input-group input-group-rounded mt-3">
                <form action="{{url('stockledgersearch')}}" method="POST">
                    @csrf
                    <div class="form-group ml-5">
                        <div class="row">
                            <select class="form-control col supplier_rec" name="categoryid" id="categoryid"
                                style="width:200px">
    ...
    <div class="card p-3">
        <div class="bootstrap-data-table-panel">
            <div class="table-responsive">
                <div class="row">
                    <div class="col-lg-1">
                        <a href="{{url('stockprint')}}"class="btn btn-primary mb-3">print</a>
