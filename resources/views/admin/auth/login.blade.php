...
<div class="login-box">
  <div class="login-logo">
    <p><b>Member</b>Login</p>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">member login page</p>

      <form method="POST" action="{{ route('login') }}">
        @csrf
        <div class="input-group mb-3">
          <input id="email" type="email" placeholder="Username or Email" class="form-control" name="email" :value="old('email')" required autofocus>
